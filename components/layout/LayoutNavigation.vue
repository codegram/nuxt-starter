    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
            <NuxtLink
              :to="{ name: 'index' }"
              exact
              active-class="border-red-500 hover:border-red-500"
        ...
        <div class="hidden sm:ml-6 sm:flex sm:items-center">
          ...
          <div class="relative ml-3">
            <div>
              <button
                id="user-menu"
                class="flex items-center max-w-xs text-sm bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                aria-haspopup="true"
        ...
        <div class="flex items-center -mr-2 sm:hidden">
          <!-- Mobile menu button -->
          <button
            class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            @click="menuOpen = !menuOpen"
          >
    ...
    >
      ...
      <div class="pt-4 pb-3 border-t border-gray-200">
        <div class="flex items-center px-4">
          ...
          <button
            class="flex-shrink-0 p-1 ml-auto text-gray-400 bg-white rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          >
            <span class="sr-only">View notifications</span>
            <!-- Heroicon name: bell -->
            <svg
